...
def main():
    ...
    query_image = cv2.imread(
        "/home/mike/Desktop/GoogleDrive/UA/Aulas/2023-2024/1ºSem/SAVI_23-24/savi_23-24/Parte06/images/machu_pichu/2.png")
    ...
    cv2.imwrite('query_image_transformed.png', query_image_transformed)
